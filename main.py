...
def run():
    ...
    try:
        ...
        # Define the prompt
        prompt = ("Generate a short, optimistic, and fun daily horoscope for today. Keep it general, not tied to any "
                  "specific zodiac sign. Maximum 3 sentences. add relevant emojis to the horoscope.")
        print(f"\nUsing prompt: '{prompt}'")
